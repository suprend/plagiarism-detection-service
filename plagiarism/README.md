...
API слушает на `:$PORT` (по умолчанию 8080). Отчёты пишутся в `plagiarism/reports` относительно рабочего каталога.
...
curl "http://localhost:8080/works/work-1/reports" | jq .
```
